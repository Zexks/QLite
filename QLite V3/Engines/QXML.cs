...
{
    public class QXML : IDisposable
    {
        #region Counts
        public static int CountOneDeep(string item1)
        {
            int count = 0;
            Global.Defaults.XmlDefaults.Load("QLite2.xml");

            foreach (XmlNode node1 in Global.Defaults.XmlDefaults.ChildNodes)
        ...
        {
            XmlNode tmpNode = Global.Defaults.XmlDefaults.Clone();
        ...
        {
            foreach (XmlNode node1 in Global.Defaults.XmlDefaults.ChildNodes[0])
        ...
        {
            foreach (XmlNode node1 in Global.Defaults.XmlDefaults.ChildNodes[0].ChildNodes)
                if (node1.Name.ToUpper() == "OPTIONS")
                    foreach (XmlNode node2 in node1.ChildNodes)
        ...
        */
        ...
        {
            XmlNode newQueryNode = Global.Defaults.XmlDefaults.CreateNode(XmlNodeType.Element, qFont.Type.ToString(), Global.Defaults.XmlDefaults.NamespaceURI);
            newQueryNode.Attributes.Append(Global.Defaults.XmlDefaults.CreateAttribute("Name"));
            newQueryNode.Attributes[0].Value = qFont.QFont.Name;

            newQueryNode.Attributes.Append(Global.Defaults.XmlDefaults.CreateAttribute("Size"));
            newQueryNode.Attributes[1].Value = qFont.QFont.Size.ToString();

            newQueryNode.Attributes.Append(Global.Defaults.XmlDefaults.CreateAttribute("Style"));
            foreach (bool s in qFont.Style) newQueryNode.Attributes[2].Value += Convert.ToInt32(s).ToString();

            newQueryNode.Attributes.Append(Global.Defaults.XmlDefaults.CreateAttribute("fColor"));
            ...
            newQueryNode.Attributes.Append(Global.Defaults.XmlDefaults.CreateAttribute("bColor"));
        ...
        */
        ...
        {
            foreach (XmlNode optionNode in Global.Defaults.XmlDefaults.ChildNodes[0].ChildNodes)
        ...
        {
            foreach (XmlNode optionsNode in Global.Defaults.XmlDefaults.ChildNodes[0].ChildNodes)
        ...
        {
            XmlNode newQueryNode = Global.Defaults.XmlDefaults.CreateNode(XmlNodeType.Element, "Query", Global.Defaults.XmlDefaults.NamespaceURI);
            newQueryNode.Attributes.Append(Global.Defaults.XmlDefaults.CreateAttribute("Title"));
            newQueryNode.Attributes[0].Value = inQuery.Title;
            newQueryNode.Attributes.Append(Global.Defaults.XmlDefaults.CreateAttribute("Type"));
            newQueryNode.Attributes[1].Value = inQuery.Parent.ToString();
            newQueryNode.Attributes.Append(Global.Defaults.XmlDefaults.CreateAttribute("Index"));
            newQueryNode.Attributes[2].Value = inQuery.Index.ToString();
            newQueryNode.AppendChild(Global.Defaults.XmlDefaults.CreateCDataSection(inQuery.Text));
            foreach (QueryVariable var in inQuery.Variables)
            {
                XmlNode varNode = Global.Defaults.XmlDefaults.CreateNode(XmlNodeType.Element, "Var", Global.Defaults.XmlDefaults.NamespaceURI);
                varNode.Attributes.Append(Global.Defaults.XmlDefaults.CreateAttribute("Default"));
                varNode.Attributes[0].Value = inQuery.Variables[inQuery.Variables.IndexOf(var)].Default;
                varNode.AppendChild(Global.Defaults.XmlDefaults.CreateCDataSection(inQuery.Variables[inQuery.Variables.IndexOf(var)].Question));
        ...
        {
            foreach (XmlNode menus in Global.Defaults.XmlDefaults.ChildNodes[0])
        ...
        {
            XmlNode newMenuNode = Global.Defaults.XmlDefaults.CreateNode(XmlNodeType.Element, "Item", Global.Defaults.XmlDefaults.NamespaceURI);
            newMenuNode.Attributes.Append(Global.Defaults.XmlDefaults.CreateAttribute("Title"));
            newMenuNode.Attributes[0].Value = menu.Name;
            newMenuNode.Attributes.Append(Global.Defaults.XmlDefaults.CreateAttribute("Type"));
