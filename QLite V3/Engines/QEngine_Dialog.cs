...
{
    public class QEngine_Dialog : IDisposable
    {
        public static DialogResult ServerLogonDialog(ref string value)
        {
            ...
            if (value.Equals(""))
            {
                if (Global.QliteDefaults.Connection[1] == "")
                { txtMachine.Text = System.Environment.MachineName.ToString(); }
                else { txtMachine.Text = Global.QliteDefaults.Connection[1]; }
                txtInstance.Text = Global.QliteDefaults.Connection[0];
                txtLogin.Text = Global.QliteDefaults.Connection[2];
                txtPassword.Text = Global.QliteDefaults.Connection[3];
            }
            else
            {
            ...
            txtPassword.UseSystemPasswordChar = Global.QliteDefaults.PasswordLock;
        ...
        {
            XmlNode tmpNode = QEngine_XML.PullTwoDeep("Help", "About");
            ...
            pbLogo.Image = Image.FromStream(QEngine_Main.GetResImage("q2icon.ico"));
