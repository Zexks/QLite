...
using QLite.Collections.TabStyles;
...
namespace QLite.Objects.QTabs
{
    ...
    public abstract class TabStyleProvider : Component
    {
        ...
        protected TabStyleProvider(QLite.Controls.QTabs tabControl)
        {
        ...
        public static TabStyleProvider CreateProvider(QLite.Controls.QTabs tabControl)
        {
        ...
        protected QLite.Controls.QTabs _TabControl;
        ...
        public Color BorderColorSelected
        {
            get
            {
                if (this._BorderColorSelected.IsEmpty) return ThemedColors.ToolBorder;
                else return this._BorderColorSelected;
            }
            set
            {
                if (value.Equals(ThemedColors.ToolBorder)) this._BorderColorSelected = Color.Empty;
                else this._BorderColorSelected = value;
                this._TabControl.Invalidate();
            }
        }
        ...
        public Color BorderColorHot
        {
            get
            {
                if (this._BorderColorHot.IsEmpty) return SystemColors.ControlDark;
                else return this._BorderColorHot;
            }
            set
            {
                if (value.Equals(SystemColors.ControlDark)) this._BorderColorHot = Color.Empty;
                else this._BorderColorHot = value;
                this._TabControl.Invalidate();
            }
        }
        ...
        public Color BorderColor
        {
            get
            {
                if (this._BorderColor.IsEmpty) return SystemColors.ControlDark;
                else return this._BorderColor;
            }
            set
            {
                if (value.Equals(SystemColors.ControlDark)) this._BorderColor = Color.Empty;
                else this._BorderColor = value;
                this._TabControl.Invalidate();
            }
        }
        ...
        public Color TextColor
        {
            get
            {
                if (this._TextColor.IsEmpty) return SystemColors.ControlText;
                else return this._TextColor;
            }
            set
            {
                if (value.Equals(SystemColors.ControlText)) this._TextColor = Color.Empty;
                else this._TextColor = value;
                this._TabControl.Invalidate();
            }
        }
        ...
        public Color TextColorSelected
        {
            get
            {
                if (this._TextColorSelected.IsEmpty) return SystemColors.ControlText;
                else return this._TextColorSelected;
            }
            set
            {
                if (value.Equals(SystemColors.ControlText)) this._TextColorSelected = Color.Empty;
                else this._TextColorSelected = value;
                this._TabControl.Invalidate();
            }
        }
        ...
        public Color TextColorDisabled
        {
            get
            {
                if (this._TextColor.IsEmpty) return SystemColors.ControlDark;
                else return this._TextColorDisabled;
            }
            set
            {
                if (value.Equals(SystemColors.ControlDark)) this._TextColorDisabled = Color.Empty;
                else this._TextColorDisabled = value;
                this._TabControl.Invalidate();
            }
        }
        ...
        public void PaintTab(int index, Graphics graphics)
        {
            using (GraphicsPath tabpath = this.GetTabBorder(index))
            {
                using (Brush fillBrush = this.GetTabBackgroundBrush(index))
                {
                    ...
                    if (this._TabControl.Focused) this.DrawTabFocusIndicator(tabpath, index, graphics);
