...
namespace QLite.Objects.QTextSupport
{
    public abstract class Style : IDisposable
    {
        ...
        public virtual void OnVisualMarkerClick(QText tb, VisualMarkerEventArgs args)
        {
            if (VisualMarkerClick != null)
                VisualMarkerClick(tb, args);
        }

        protected virtual void AddVisualMarker(QText tb, StyleVisualMarker marker)
        {
    ...
    public class TextStyle : Style
    {
        ...
        public override void Draw(Graphics gr, Point position, Range range)
        {
            ...
            if (range.tb.ImeAllowed)
                ...
                {
                    SizeF size = QText.GetCharSize(f, line[i].c);
